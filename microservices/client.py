...
from helpers.client import create_subscription, check_subscription
...
def signup_user():
    ...
    hashed_password = (
        generate_password_hash(data.get("password"), method="sha256")
    ...
    response = check_subscription(existing_email)
